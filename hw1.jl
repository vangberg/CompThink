...
student = (name = "Harry", kerberos_id = "jazz")
...
# ╔═╡ 3db3aa4f-6c01-4657-b6ee-65b54a0b1b6b
get_green.(philip_head)

# ╔═╡ 7c1ab7ed-c292-46e1-9fc5-8341ae0bed10
...
function noisify(x::Number, s)
	# your code here!
	return clamp(x + (-s + rand() * 2s), 0.0, 1.0)
end
...
function noisify(color::AbstractRGB, s)
	# your code here!
	return RGB(
		noisify.([color.r, color.g, color.b], s)...
	)
end
